...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        .route(
            "/folios/entries", 
            post(create_folio_entry_handler),
        )
        .route(
            "/folios/payments", 
        ...
        .route(
            "/folios/deposits", 
            post(create_deposit_handler),
        )
        .route(
            "/folios/:id", 
            get(get_folio_handler),
        )
        .route(
        ...
        .route(
            "/receivables/aging", 
            get(get_receivable_aging_handler),
        )
        .route(
            "/receivables/:id", 
            get(get_receivable_handler),
        )
        .route(
        ...
        .route(
            "/receivables/:id/dispute", 
            post(dispute_receivable_handler),
        )
        .route(
