...
use crate::{
    ...
    projection::{
        access::list_guest_ids::list_guest_ids,
        aggregate::materializer::materialize_guest_aggregate::materialize_guest_aggregate,
...
pub async fn rebuild_guest_aggregate(tx: &mut Transaction<'_, Sqlite>) -> AppResult<()> {
